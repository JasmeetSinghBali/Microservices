...
func (m *Product) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGlaze(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Product) validateGlaze(formats strfmt.Registry) error {

	if err := validate.Required("glaze", "body", m.Glaze); err != nil {
		return err
	}

	if err := validate.Pattern("glaze", "body", *m.Glaze, `[a-z]+-(top|bottom)+-[a-z]+`); err != nil {
		return err
	}
